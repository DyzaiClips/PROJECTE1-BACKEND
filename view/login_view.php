...
<div class="container mt-5" >
    <div class="row justify-content-center">
        <div class="col-md-5" > <!-- Login wodth colums -->
            <h2 class="text-center mb-4" style="color: ;"><b>Inici de sesió</b></h2>
            <form action="../controller/login_controller.php" method="POST" class="border p-4 bg-light"  >
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary" style="background-color: aquamarine; border-color: aquamarine; ;"><?= $text['send_button'];?></button>
                </div>
                <!-- Direct acces to register -->
                <div class="mt-3 text-center">
                    <p><?= $text['no_useraccount']?>

                    <a style="color:#38AB75" href="./register_view.php"> <?= $text['register_link']?></a></p>
                </div>
                <!-- Errors control -->
                <div class="mt-3 text-center">
